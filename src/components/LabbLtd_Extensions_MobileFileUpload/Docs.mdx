...
This component can be linked to an out of the box file upload component.
Set the `reference` property to the ID of the file upload component to enable the retry mechanism.
Set the `referenceTestID` to the test ID of the file upload component to set the capture and accept attributes.
