...
import StyledLabbLtdExtensionsTestWrapper from './styles';

// interface for props
interface LabbLtdExtensionsTestProps extends PConnFieldProps {
...
function LabbLtdExtensionsTest(props: LabbLtdExtensionsTestProps) {
  ...
  return (
    <StyledLabbLtdExtensionsTestWrapper>
    <PegaAppAnnouncement
      heading={header}
...
export default withConfiguration(LabbLtdExtensionsTest);
