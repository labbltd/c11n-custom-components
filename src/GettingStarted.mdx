...
Welcome to the Labb's Constellation DX Components UI Gallery!
...
This gallery provides a collection of ready-to-use and customizable components, built and maintained by [Labb ltd](https://www.labb.ltd). Explore them directly or [delve into the source code](https://github.com/labbltd/c11n-custom-components/tree/master/src/components) for deeper understanding.

### Compatibility:

These components have been built against version 24.x of Pega Infinity.
